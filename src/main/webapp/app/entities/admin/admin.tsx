...
export const Admin = (props: IAdminProps) => {
  ...
  return (
    <div>
      <h2 id="admin-heading">
        <Translate contentKey="dashboardApp.admin.home.title">Admins</Translate>
        <Link to={`${match.url}/new`} className="btn btn-primary float-right jh-create-entity" id="jh-create-entity">
          <FontAwesomeIcon icon="plus" />
          &nbsp;
          <Translate contentKey="dashboardApp.admin.home.createLabel">Create new Admin</Translate>
        </Link>
      </h2>
        ...
        {adminList && adminList.length > 0 ? (
            ...
            <tbody>
              {adminList.map((admin, i) => (
                <tr key={`entity-${i}`}>
                  ...
                  <td>
                    {admin.adminCreatedAt ? <TextFormat type="date" value={admin.adminCreatedAt} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
                  <td>
                    {admin.adminModifiedAt ? <TextFormat type="date" value={admin.adminModifiedAt} format={APP_LOCAL_DATE_FORMAT} /> : null}
                  </td>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="dashboardApp.admin.home.notFound">No Admins found</Translate>
            </div>
          )
        )}
      </div>
